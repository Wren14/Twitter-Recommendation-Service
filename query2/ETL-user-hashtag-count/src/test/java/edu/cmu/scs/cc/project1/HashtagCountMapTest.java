...
public class HashtagCountMapTest {
	...
	public void testWordCountMapper() throws IOException {
		...
		String outputKey1 = String.format("%s\t%s%s", userId, "metoo", LINE_SEPARATOR);
		String outputKey2 = String.format("%s\t%s%s", userId, "cmu", LINE_SEPARATOR);
		String outputKey3 = String.format("%s\t%s%s", userId, "cc", LINE_SEPARATOR);
		String outputKey4 = String.format("%s\t%s%s", userId, "cmu", LINE_SEPARATOR);
